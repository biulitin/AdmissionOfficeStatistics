...
SELECT 
  ...
  KL.kl_name  AS c2_2v4_5,
  'бюджет' AS c3_3v4_4,
  (SELECT SUM(Qo) FROM PlanPr, Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id) AS c4_4v4_4,
  (SELECT SUM(Lg) FROM PlanPr,Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id)  AS c5_5v4_4,
  (SELECT SUM(Qo) FROM PlanPr, Speciality WHERE KL.kl_id = PlanPr.kl_id AND PlanPr.sp_id = Speciality.sp_id AND isNULL(Speciality.sp_C,'') != '' AND Speciality.sp_Name = SP.sp_Name AND KL.kl_id = PlanPr.kl_id) AS c6_6v4_4,
  (SELECT SUM(Qo) FROM PlanPr,Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id) - (SELECT SUM(Lg) FROM PlanPr, Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id) - (SELECT SUM(Qo) FROM PlanPr, Speciality WHERE PlanPr.sp_id = Speciality.sp_id AND KL.kl_id = PlanPr.kl_id AND isNULL(Speciality.sp_C,'') != '' AND Speciality.sp_Name = SP.sp_Name AND KL.kl_id = PlanPr.kl_id)  AS c7_7v4_4,
  'коммерция' AS c3_3v5_5,
  (SELECT SUM(F) FROM PlanPr, Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id) AS c4_4v5_5,
  (SELECT SUM(F) FROM PlanPr, Speciality WHERE SP.sp_Name = Speciality.sp_Name AND Speciality.sp_id = PlanPr.sp_id AND KL.kl_id = PlanPr.kl_id)  AS c7_7v5_5
...
SELECT 
  ...
  KL.kl_name  AS c2_2v6_7,
  'бюджет' AS c3_3v6_6,
  (SELECT COUNT(*) FROM Speciality, AbitSp WHERE Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=1 AND AbitSp.d_data<='26.07.2017 0:00:00.000')  AS c4_4v6_6, 
  (SELECT COUNT(DISTINCT(AbitSp.aid)) FROM Speciality, AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=1 AND AbitSp.d_data<='26.07.2017 0:00:00.000' AND l_id>0) AS c5_5v6_6,
  (SELECT COUNT(DISTINCT(AbitSp.aid)) FROM Speciality, AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=1 AND AbitSp.d_data<='26.07.2017 0:00:00.000' AND l1_id>0)  AS c6_6v6_6, 
  ...
  (SELECT COUNT(DISTINCT(AbitSp.aid)) FROM Speciality, AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=1 AND AbitSp.d_data<='26.07.2017 0:00:00.000' AND isNULL(SP.sp_C,'') != '')  AS c8_8v6_6, 
  (SELECT COUNT(*) FROM Speciality, AbitSp WHERE Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=1 AND AbitSp.d_data>'26.07.2017 0:00:00.000')  AS c9_9v6_6,
  'коммерция'  AS c3_3v7_7,
  (SELECT COUNT(DISTINCT(AbitSp.aid)) FROM Speciality, AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=2 AND AbitSp.d_data<='26.07.2017 0:00:00.000') AS c4_4v7_7,
  ...
  (SELECT COUNT(DISTINCT(AbitSp.aid)) FROM Speciality, AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND Speciality.sp_id = AbitSp.sp_id AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_Name = SP.sp_Name AND f=2 AND AbitSp.d_data>'26.07.2017 0:00:00.000')  AS c9_9v7_7
   FROM Speciality SP, KindLearn KL, PlanPr PP WHERE (
		SP.sp_id = PP.sp_id  
	AND KL.kl_id = PP.kl_id 
	AND isNULL(SP.sp_C,'') = '');
...
SELECT 
  ...
  KL.kl_name  AS c2_2v8_9,
  'бюджет' AS c3_3v8_8,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id = AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND AbitSp.f = 1 AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)))  AS c4_4v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND SP.sp_id = AbitSp.sp_id AND AbitSp.f = 1 AND Abit.l_id > 0 AND Lgot.fid = Abit.l_id AND Lgot.fName LIKE '%Всерос%' AND (z=1 OR z_2014=4))  AS c5_5v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND SP.sp_id = AbitSp.sp_id AND AbitSp.f = 1 AND Abit.l_id > 0 AND Lgot.fid = Abit.l_id AND Lgot.fName LIKE '%всеукр%' AND (z=1 OR z_2014=4))  AS c6_6v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND SP.sp_id = AbitSp.sp_id AND AbitSp.f = 1 AND Abit.l_id > 0 AND Lgot.fid = Abit.l_id AND (Lgot.fName NOT LIKE '%Всерос%' AND  Lgot.fName NOT LIKE '%всеурк%' AND Lgot.fName NOT LIKE '%олимп* игр%') AND (z=1 OR z_2014=4))  AS c7_7v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND SP.sp_id = AbitSp.sp_id AND AbitSp.f = 1 AND Abit.l_id > 0 AND Lgot.fid = Abit.l_id AND Lgot.fName LIKE '%олимп* игр%' AND (z=1 OR z_2014=4))  AS c8_8v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND SP.sp_id = AbitSp.sp_id AND AbitSp.f = 1 AND Abit.l1_id > 0 AND (z=1 OR z_2014=4))  AS c9_9v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit, Lgot, Speciality WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND Speciality.sp_id = AbitSp.sp_id AND SP.sp_Name = Speciality.sp_Name AND isNULL(Speciality.sp_C,'') = '' AND (z=1 OR z_2014=4))  AS c10_10v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id  AND AbitSp.f = 1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (Abit.l1_id = 0 OR Abit.l1_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7))) AS c14_14v8_8, 
  ...
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (Abit.l1_id = 0 OR Abit.l1_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND AbitEGE.m100b > 0))  AS c16_16v8_8, 
  'коммерция' AS c3_3v9_9,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id = AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND AbitSp.f = 2 AND (AbitSp.z>0 or AbitSp.z_2014=7)) AS c4_4v9_9,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid = AbitSp.aid AND KL.kl_id = AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id  AND AbitSp.f = 2 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (Abit.l1_id = 0 OR Abit.l1_id IS NULL) AND (AbitSp.z>0 or AbitSp.z_2014=7))  AS c14_14v9_9, 
...
SELECT 
  SP.sp_Name  AS c1_1v8_9, 
   KL.kl_name  AS c2_2v8_9,
  'бюджет'AS c3_3v8_8,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND f=1 AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7))) AS c4_4v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Speciality, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND f=1 AND Abit.l_id>0 AND (AbitSp.z=1 OR AbitSp.z_2014=4)) AS c5_5v8_8, 			
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND Abit.l1_id>0 AND (AbitSp.z=1 OR AbitSp.z_2014=4))  AS c6_6v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND Abit.l1_id>0 AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE Abit.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != ''))) AS c7_7v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND Abit.l1_id>0 AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND EXISTS(SELECT * FROM AbitEGE WHERE Abit.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')) AND EXISTS(SELECT * FROM AbitEGE WHERE Abit.aid = AbitEGE.aid AND isNULL(y_ege,'') != ''))  AS c8_8v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND Abit.l1_id>0 AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND EXISTS(SELECT * FROM AbitEGE WHERE Abit.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != ''))) AS c9_9v8_8,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND isNULL(Speciality.sp_C,'') != '' AND (AbitSp.z=1 OR AbitSp.z_2014=4)) AS c10_10v8_8,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND isNULL(Speciality.sp_C,'') != '' AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != ''))) AS c11_11v8_8, 
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND isNULL(Speciality.sp_C,'') != '' AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '') OR isNULL(d_ex,'') != '') AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND isNULL(y_ege,'') != '')) AS c12_12v8_8,
  (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND isNULL(Speciality.sp_C,'') != '' AND (AbitSp.z=1 OR AbitSp.z_2014=4) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '') OR isNULL(d_ex,'') != '')) AS c13_13v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)))  AS c14_14v8_8,
  ...
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND AbitEGE.m100b > 0)) AS c16_16v8_8, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '') OR isNULL(d_ex,'') != '') AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND isNULL(y_ege,'') != '')) AS c17_17v8_8,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=1 AND (Abit.l_id = 0 OR Abit.l_id IS NULL) AND (AbitSp.z>0 OR (AbitSp.z_2014>0 AND AbitSp.z_2014<7)) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '') OR isNULL(d_ex,'') != '')) AS c18_18v8_8,
  'коммерция'  AS c3_3v9_9,
   (SELECT COUNT(*) FROM AbitSp, Speciality WHERE KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = Speciality.sp_id AND SP.sp_Name = Speciality.sp_Name AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7)) AS c4_4v9_9, 
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7)) AS c14_14v9_9,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND AbitEGE.m100b > 0)) AS c15_15v9_9,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7) AND NOT EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND AbitEGE.m100b > 0)) AS c16_16v9_9,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND isNULL(y_ege,'') != '')) AS c17_17v9_9,
  (SELECT COUNT(DISTINCT(Abit.aid)) FROM AbitSp, Abit WHERE Abit.aid=AbitSp.aid AND KL.kl_id=AbitSp.kl_id AND AbitSp.sp_id = SP.sp_id AND f=2 AND (AbitSp.z>0 OR AbitSp.z_2014=7) AND EXISTS(SELECT * FROM AbitEGE WHERE AbitSp.aid = AbitEGE.aid AND (isNULL(gr,'') != '' OR isNULL(d_ex,'') != '')))  AS c18_18v9_9 
   FROM Speciality SP, KindLearn KL, PlanPr PP WHERE (
		SP.sp_id = PP.sp_id  
	AND KL.kl_id = PP.kl_id 
	AND isNULL(SP.sp_C,'') = '');